...
from resnet import ResNet20Test, ResNet20relux8, ResNet20relux7, ResNet20relux6
...
def testCode():
    ...
    state_dict = torch.load('../cnn/91.74best_acc_cifar10.pth')
    model.load_state_dict(state_dict['model'], False)
    model.eval()
...
def testReLUx6():
    ...
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    # model = ResNet20().to(device)
    model = ResNet20relux6().to(device)
    # print(model)
...
def testReLUx7():
    ...
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    # model = ResNet20().to(device)
    model = ResNet20relux7().to(device)
    # print(model)
...
def testReLUx8():
    ...
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    # model = ResNet20().to(device)
    model = ResNet20relux8().to(device)
    # print(model)
